...
<p><img src="/public/scoreboard/screen.png" style="float: right;" alt="screen">Our scoring system is multi-discipline. Each discipline has their own scoring requirements, but in general the scoring elements follow similar rules and judging forms can be tailored to the needs of each discipline or event.</p>
