...
<p>Client laptops can be almost anything that can run a browser. Any device will do, and we encourage users to provide their own device (be it laptop, tablet, mobile phone).</p>
<ul>
