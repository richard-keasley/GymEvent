...
<p><img src="/app/scoreboard/screen.png" style="float:right;" alt="screen">The application displays scores to audiences in "real time". Score corrections are also displayed.</p>
