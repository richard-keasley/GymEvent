...
<p>Please click <?php echo anchor(base_url("reset/reset/{$user->reset_key}"), 'this link to reset your password');?>.</p>
<p><strong>Note:</strong> This link is only valid for a short amount of time. Please do not delay!</p>
