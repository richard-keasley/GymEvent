...
<p>If you don't know a  participant's BG number, enter a 'place marker' of "1" (.e.g <code>John, Doe, 1, 12 Oct 70</code>).</p>

<p>We need this information to verify your membership status with BG and to ensure participants are entered in to the correct category. Read our <?php echo anchor('about/policy', 'privacy policy');?> for more information.</p>  
