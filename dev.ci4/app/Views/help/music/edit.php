...
<?php $preferred = \App\Libraries\Track::exts_allowed[0]; ?>
	<p>Uploaded tracks must be playable on <em>our machine</em>. There are many types of music file. <code><?php echo $preferred;?></code> is the easiest format to work with and we prefer all music to be in this format.</p>
	<p>If your music is of an unsupported type, you should convert it to an <code><?php echo $preferred;?></code> file on a computer it will play on. There are many free programs that do this, we recommend VLC media player. Use the largest file size setting (320Kbps) when converting the audio file.</p>
	<p>Ask Richard for help if you really can not do this.</p>
</div>
</div>
</li>
...
<div class="card card-body">
	...
	<h5>Example:</h5>
	<p><span class="bi bi-hand-thumbs-up-fill text-success"></span> <code>jane_music.<?php echo $preferred;?></code><br>
	<span class="bi bi-hand-thumbs-down-fill text-danger"></span> <code>jane's music.<?php echo $preferred;?></code></p>
</div>
</div>
</li>
...
<div class="card card-body">
	...
	<p>If the file is a 'Windows Media Audio' file (<code>wma</code>), the best way to remove the protection is to convert the track to <code><?php echo $preferred;?></code> on the PC it will play on. There are many free programs that do this, we recommend VLC media player. Use the largest file size setting (320Kbps) when converting the audio file.</p>
...
<div class="card card-body">
	...
	<p>British Gymnastics holds a "Dubbing Licence", which only covers the <em>replication</em> (e.g. transferring music from CD to website or USB stick). The event organiser will need a PPL/PRS licence to cover the <em>playing</em> of music at the event. This licence will  usually be part of the venue agreement. For full information regarding music licencing, please read
	<a href="https://www.british-gymnastics.org/clubs/club-membership/music-licensing-ppl-prs">
	Music Licensing – PPL/PRS "Playing Music In public</a>
	on the British Gymnastics web-site.</p>
</div>
</li>
</ol>
